...
- The impact you believe the issue has (e.g. RCE, data exposure, privilege escalation)

## What to Expect
We'll acknowledge good-faith reports and work with you to understand and resolve the issue. Response times are best-effort since this is a small, privately maintained fork — please be patient and keep details confidential until a fix has shipped.
