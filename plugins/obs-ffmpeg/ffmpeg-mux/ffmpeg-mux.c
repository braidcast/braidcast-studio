 ...
 * back-pressures into the muxer and stalls the very stream the message is
 * reporting on. Per window rather than per lifetime so a long broadcast cannot
 * fall permanently silent after one early burst. */
