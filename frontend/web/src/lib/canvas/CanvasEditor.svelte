<script lang="ts">
  ...
  import { seedForm, toUpdateParams } from "$lib/canvas/canvasForm";
  ...
  import CanvasAdvancedTab from "$lib/canvas/CanvasAdvancedTab.svelte";
  import CanvasDestinationsTab from "$lib/canvas/CanvasDestinationsTab.svelte";
