...
#include "win_dll_blocklist.h"

#include <Windows.h>
// NTSTATUS: the target compiles with WIN32_LEAN_AND_MEAN, which drops the wincrypt.h
// chain Windows.h would otherwise pull the typedef in through.
#include <winternl.h>
#include <psapi.h>
#include <stdint.h>
#include <stdbool.h>
